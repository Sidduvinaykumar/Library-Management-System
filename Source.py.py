...
class menu:
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Books',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.addbook).place(x=12,y=100)
        l2=Button(self.a,text='Search Books',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.search).place(x=12,y=200)

        l4=Button(self.a,text='All Books',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.all).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.mainmenu).place(x=12,y=500)
    ...
    def addbook(self):
        ...
        l1=Label(self.f1,text='Book ID : ',font='Papyrus 12 bold',fg='blue',bg='Black',pady=1).place(x=50,y=50)
        e1=Entry(self.f1,width=45,bg='blue',fg='black',textvariable=self.aid).place(x=150,y=50)
        l2=Label(self.f1,text='Title : ',font='Papyrus 12 bold',fg='blue',bg='Black',pady=1).place(x=50,y=100)
        e2=Entry(self.f1,width=45,bg='blue',fg='black',textvariable=self.aname).place(x=150,y=100)
        l3=Label(self.f1,text='Author : ',font='Papyrus 12 bold',fg='blue',bg='Black',pady=1).place(x=50,y=150)
        e3=Entry(self.f1,width=45,bg='blue',fg='black',textvariable=self.aauthor).place(x=150,y=150)
        l4=Label(self.f1,text='Genre : ',font='Papyrus 12 bold',fg='blue',bg='Black',pady=1).place(x=50,y=200)
        e2=Entry(self.f1,width=45,bg='blue',fg='black',textvariable=self.agenre).place(x=150,y=200)
        l4=Label(self.f1,text='Copies : ',font='Papyrus 12 bold',fg='blue',bg='Black',pady=1).place(x=50,y=250)
        e2=Entry(self.f1,width=45,bg='blue',fg='black',textvariable=self.acopies).place(x=150,y=250)
        l5=Label(self.f1,text='Location : ',font='Papyrus 12 bold',fg='blue',bg='Black',pady=1).place(x=50,y=300)
        e3=Entry(self.f1,width=45,bg='blue',fg='black',textvariable=self.aloc).place(x=150,y=300)
        self.f1.grid_propagate(0)
        b1=Button(self.f1,text='Add',font='Papyrus 10 bold',fg='black',bg='blue',width=15,bd=3,command=self.adddata).place(x=150,y=400)
        b2=Button(self.f1,text='Back',font='Papyrus 10 bold',fg='black',bg='blue',width=15,bd=3,command=self.rm).place(x=350,y=400)
    ...
    def search(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID/Title/Author/Genre: ',font=('Papyrus 10 bold'),bd=2, fg='blue',bg='black').place(x=20,y=40)
        e1=Entry(self.f1,width=25,bd=5,bg='blue',fg='black',textvariable=self.sid).place(x=260,y=40)
        b1=Button(self.f1,text='Search',bg='blue',font='Papyrus 10 bold',width=9,bd=2,command=self.serch1).place(x=500,y=37)
        b1=Button(self.f1,text='Back',bg='blue',font='Papyrus 10 bold',width=10,bd=2,command=self.rm).place(x=250,y=450)
    ...
    def copies(self,varr):
        try:
            ...
            if varr==0:
                b5=Button(self.f1,text='Update',font='Papyrus 10 bold',bg='blue',fg='black',width=9,bd=3,command=self.copiesadd).place(x=500,y=97)
            if varr==1:
                b6=Button(self.f1,text='Update',font='Papyrus 10 bold',bg='blue',fg='black',width=9,bd=3,command=self.copiesdelete).place(x=500,y=97)
        except:
            messagebox.showinfo("Empty","Please select something.")
    ...
    def all(self):
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        b1=Button(self.f1,text='Back',bg='blue' ,fg='black',width=10,bd=3,command=self.rm).place(x=250,y=400)
        conn=sqlite3.connect('test.db')
    ...
    def student(self):
        self.a.destroy()
        self.a=self.canvases(image2)
        l1=Button(self.a,text='Issue book',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.issue).place(x=12,y=100)
        l2=Button(self.a,text='Return Book',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.returnn).place(x=12,y=200)
        l3=Button(self.a,text='Student Activity',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.activity).place(x=12,y=300)
        l4=Button(self.a,text='<< Main Menu',font='Papyrus 22 bold',fg='blue',bg='Black',width=15,padx=10,command=self.mainmenu).place(x=12,y=600)
    ...
    def issue(self):
        ...
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='papyrus 15 bold',bg='black',fg='blue').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='blue',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='papyrus 15 bold',bg='black',fg='blue').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='blue',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Papyrus 10 bold',fg='black',bg='blue',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Issue',font='Papyrus 10 bold',fg='black',bg='blue',width=10,bd=3,command=self.issuedbook).place(x=200,y=250)
    ...
    def returnn(self):
        ...
        self.f1=Frame(self.a,height=550,width=500,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='papyrus 15 bold',fg='blue', bg='black').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='blue',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='papyrus 15 bold',fg='blue', bg='black').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='blue',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='Papyrus 10 bold',bg='blue',fg='black',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Return',font='Papyrus 10 bold',bg='blue',fg='black',width=10,bd=3,command=self.returnbook).place(x=200,y=250)
        self.f1.grid_propagate(0)
    ...
    def activity(self):
        ...
        l1=Label(self.f1,text='Book/Student ID : ',font='Papyrus 15 bold',fg='blue',bg='black').place(x=50,y=30)
        e1=Entry(self.f1,width=20,bd=4,bg='blue',textvariable=self.aidd).place(x=280,y=35)
        #l2=Label(self.f1,text='Student Id : ',font='papyrus 15 bold',fg='blue',bg='black').place(x=50,y=80)
        #e2=Entry(self.f1,width=20,bd=4,bg='blue',textvariable=self.astudentt).place(x=180,y=80)
        b1=Button(self.f1,text='Back',bg='blue',font='Papyrus 10 bold',width=10,bd=3,command=self.rm).place(x=340,y=450)
        b1=Button(self.f1,text='Search',bg='blue',font='Papyrus 10 bold',width=10,bd=3,command=self.searchact).place(x=40,y=450)
...
def Database():
    ...
    cursor.execute("SELECT * FROM `login` WHERE `username` = 'admin' AND `password` = 'root'")
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('Siddu', 'root')")
        conn.commit()
...
#==============================LABELS=========================================
lbl_title = Label(canvas, text = "ADMIN   LOGIN", font=('Papyrus', 30,'bold', ),bg='black', fg='blue')
lbl_title.place(x=500,y=100)
lbl_username = Label(canvas, text = "Username:", font=('Papyrus', 15,'bold'),bd=4,bg='black', fg='blue')
lbl_username.place(x=500,y=230)
lbl_password = Label(canvas, text = "Password :", font=('Papyrus', 15,'bold'),bd=3, bg='black', fg='blue')
...
#==============================ENTRY WIDGETS==================================
username = Entry(canvas, textvariable=USERNAME, font=(14), bg='black', fg='blue',bd=6)
username.place(x=650, y=230,)
password = Entry(canvas, textvariable=PASSWORD, show="*", font=(14),bg='black', fg='blue',bd=6)
password.place(x=650, y=330)

#==============================BUTTON WIDGETS=================================
btn_login = Button(canvas, text="LOGIN", font=('Papyrus 15 bold'),width=25,command=Login, bg='black', fg='blue')
